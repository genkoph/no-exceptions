...
type ThunkResult<T extends SyncThunk | AsyncThunk, V = AnyToUnknown<ReturnType<T>>> =
  V extends Promise<infer U> ? ResultPromise<Result<U, Error>> : Result<V, Error>;
 ...
 */
export function attempt(thunk: AsyncThunk<never>): ResultPromise<Result<never, Error>>;
 ...
 * @returns A ResultPromise containing the success value or error
 */
export function attempt(promise: Promise<never>): ResultPromise<Result<never, Error>>;
 ...
 * @returns A ResultPromise containing the success value or error
 */
export function attempt<T = unknown>(executor: Executor<T>): ResultPromise<Result<T, Error>>;
 ...
 * @returns A ResultPromise containing the success value or error
 */
export function attempt<T>(promise: Promise<T>): ResultPromise<Result<T, Error>>;
